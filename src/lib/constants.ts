...
export const countryData: Country[] = [
  ...
  { countryCode: 'ao', countryName: 'Angola', currency: 'AOA' },
  { countryCode: 'ai', countryName: 'Anguilla', currency: 'XCD' },
  { countryCode: 'ag', countryName: 'Antigua and Barbuda', currency: 'XCD' },
  ...
  { countryCode: 'bs', countryName: 'Bahamas', currency: 'BSD' },
  { countryCode: 'bh', countryName: 'Bahrain', currency: 'BHD', pricingCurrency: 'USD' },
  { countryCode: 'bb', countryName: 'Barbados', currency: 'BBD' },
  { countryCode: 'by', countryName: 'Belarus', currency: 'BYN' },
  { countryCode: 'be', countryName: 'Belgium', currency: 'EUR' },
  { countryCode: 'bz', countryName: 'Belize', currency: 'BZD' },
  { countryCode: 'bm', countryName: 'Bermuda', currency: 'BMD' },
  { countryCode: 'bt', countryName: 'Bhutan', currency: 'BTN' },
  { countryCode: 'bo', countryName: 'Bolivia', currency: 'BOB' },
  { countryCode: 'bw', countryName: 'Botswana', currency: 'BWP' },
  { countryCode: 'br', countryName: 'Brazil', currency: 'BRL' },
  { countryCode: 'vg', countryName: 'British Virgin Islands', currency: 'USD' },
  { countryCode: 'bn', countryName: 'Brunei Darussalam', currency: 'BND' },
  ...
  { countryCode: 'dm', countryName: 'Dominica', currency: 'XCD' },
  ...
  { countryCode: 'sz', countryName: 'Eswatini', currency: 'SZL' },
  { countryCode: 'fj', countryName: 'Fiji', currency: 'FJD' },
  { countryCode: 'fi', countryName: 'Finland', currency: 'EUR' },
  { countryCode: 'fr', countryName: 'France', currency: 'EUR' },
  { countryCode: 'gm', countryName: 'Gambia', currency: 'GMD' },
  ...
  { countryCode: 'gd', countryName: 'Grenada', currency: 'XCD' },
  { countryCode: 'gt', countryName: 'Guatemala', currency: 'GTQ' },
  { countryCode: 'gy', countryName: 'Guyana', currency: 'GYD' },
  ...
  { countryCode: 'lr', countryName: 'Liberia', currency: 'LRD' },
  ...
  { countryCode: 'mg', countryName: 'Madagascar', currency: 'MGA' },
  { countryCode: 'mw', countryName: 'Malawi', currency: 'MWK' },
  ...
  { countryCode: 'mn', countryName: 'Mongolia', currency: 'MNT' },
  { countryCode: 'ms', countryName: 'Montserrat', currency: 'XCD' },
  ...
  { countryCode: 'mk', countryName: 'North Macedonia', currency: 'MKD' },
  ...
  { countryCode: 'pg', countryName: 'Papua New Guinea', currency: 'PGK' },
  ...
  { countryCode: 'sl', countryName: 'Sierra Leone', currency: 'SLL' },
  ...
  { countryCode: 'sb', countryName: 'Solomon Islands', currency: 'SBD' },
  ...
  { countryCode: 'kn', countryName: 'St. Kitts and Nevis', currency: 'XCD' },
  { countryCode: 'lc', countryName: 'St. Lucia', currency: 'XCD' },
  { countryCode: 'vc', countryName: 'St. Vincent and The Grenadines', currency: 'XCD' },
  { countryCode: 'sr', countryName: 'Suriname', currency: 'SRD' },
  ...
  { countryCode: 'ug', countryName: 'Uganda', currency: 'UGX' },
  ...
  { countryCode: 'uz', countryName: 'Uzbekistan', currency: 'UZS' },
